  ...
  return (
    ...
    >
      <View style={styles.overlay}>
        <Animated.View style={[styles.modal, { opacity: opacityAnim, transform: [{ scale: scaleAnim }] }]}>
          <LinearGradient
          ...
          >
            ...
            <View style={styles.scoreSection}>
              ...
              <Animated.Text style={styles.finalScore}>
            ...
            <View style={styles.secondaryBtns}>
              <TouchableOpacity onPress={onHome} style={styles.secondaryBtn}>
                <Feather name="home" size={18} color={COLORS.textSecondary} />
                <Text style={styles.secondaryBtnText}>HOME</Text>
              </TouchableOpacity>
              <TouchableOpacity onPress={handleShare} style={styles.secondaryBtn}>
