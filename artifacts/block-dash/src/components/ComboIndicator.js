...
const ComboIndicator = memo(function ComboIndicator({ comboCount }) {
  ...
  const colors = ['#FF6B6B', '#FF9F43', '#FFDD59', '#2ED573', '#18DCFF', '#A55EEA'];
  const color = colors[(comboCount - 2) % colors.length];
